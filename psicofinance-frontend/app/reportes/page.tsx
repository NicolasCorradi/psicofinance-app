...
export default function ReportesPage() {
  ...
  // Datos para el gráfico de líneas: real vs inflación teórica
  ...
  return (
    <main className="mx-auto max-w-screen-lg px-4 py-6 lg:py-8">
      ...
      {/* Gráfico 1: Ingresos mensuales (barras) */}
      ...
      {/* Gráfico 2: Facturación real vs inflación teórica */}
      <div className="mb-4 rounded-2xl bg-white p-5 shadow-sm ring-1 ring-black/5">
        <div className="mb-4 flex flex-wrap items-center justify-between gap-3">
          <div>
            ...
            <p className="mt-1 text-sm text-neutral-600">
              ¿Estás ganándole a la inflación?
            </p>
          </div>
        ...
        <p className="mt-2 text-[10px] text-neutral-400">
          ...
          Si tu facturación real está por encima, le estás ganando a la inflación.
        </p>
      </div>
