    ...
    <main className="mx-auto max-w-screen-lg px-4 py-6 lg:py-8">
      ...
      <div className="mb-4 flex items-center gap-2">
        <button
          ...
          className="flex h-8 w-8 items-center justify-center rounded-lg border border-neutral-200 bg-white text-neutral-500 transition-colors hover:bg-neutral-50"
          aria-label="Mes anterior"
        >
          <ChevronLeft className="h-4 w-4" />
        </button>
        <span className="min-w-[140px] text-center text-sm font-semibold capitalize text-neutral-700">
          {labelMes(mes)}
        </span>
        <button
          onClick={() => setMes(m => moverMes(m, 1))}
          disabled={mes >= mesActual()}
          className="flex h-8 w-8 items-center justify-center rounded-lg border border-neutral-200 bg-white text-neutral-500 transition-colors hover:bg-neutral-50 disabled:cursor-not-allowed disabled:opacity-30"
      ...
      {error && (
        <div className="flex flex-col items-center justify-center gap-4 py-24 text-center">
          ...
          <div>
            <p className="text-sm font-semibold text-neutral-700">No se pudieron cargar los egresos</p>
      ...
      {!error && (
        <div className="flex flex-col gap-4">
          ...
          <div className="flex flex-wrap items-center gap-2">
            ...
            {categoriasPresentes.length > 0 && <span className="h-4 w-px bg-neutral-200" />}
          ...
          <div className="overflow-hidden rounded-2xl bg-white ring-1 ring-black/5">
            {cargando ? (
              ...
              <div className="flex flex-col items-center gap-3 px-6 py-14 text-center">
                <div className="flex h-12 w-12 items-center justify-center rounded-2xl bg-neutral-50 ring-1 ring-neutral-100">
          ...
          {!cargando && filtrados.length > 0 && (
            <p className="px-1 text-right text-[11px] text-neutral-400">
