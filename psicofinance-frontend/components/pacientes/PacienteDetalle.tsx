            ...
            {detalle.pendiente > 0 && (
              <div className="border-b border-neutral-100 dark:border-slate-800 bg-white dark:bg-slate-900 px-4 py-2.5">
                <a
                  ...
                  className="flex w-full items-center justify-center gap-2 rounded-xl bg-emerald-50 dark:bg-emerald-500/10 px-4 py-2.5 text-sm font-medium text-emerald-700 dark:text-emerald-400 ring-1 ring-emerald-200 dark:ring-emerald-500/20 transition-colors hover:bg-emerald-100 dark:hover:bg-emerald-500/20"
                >
                ...
                {detalle.turnos.length === 0 ? (
                  ...
                  <div className="divide-y divide-neutral-100 dark:divide-slate-800 rounded-xl border border-neutral-100 dark:border-slate-800 bg-white dark:bg-slate-900">
                    {detalle.turnos.map((t: TurnoEnDetalle) => (
                      <div
                        key={t.id}
                        className={`flex items-center justify-between px-3.5 py-3 transition-colors hover:bg-indigo-50/30 dark:hover:bg-indigo-500/10 ${
          ...
          <div className="border-t border-neutral-100 dark:border-slate-800 px-5 py-3 bg-white dark:bg-slate-900 space-y-2">
            ...
            {confirmarEliminar ? (
              <div className="flex items-center gap-2">
                <p className="flex-1 text-xs text-red-500 dark:text-red-400">¿Eliminar a {detalle.nombre}? No se puede deshacer.</p>
                <button
                  onClick={eliminar}
                  disabled={guardando}
